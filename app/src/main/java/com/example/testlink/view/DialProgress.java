...
import com.example.testlink.BuildConfig;
import com.example.testlink.R;
import com.example.testlink.utils.Constant;
import com.example.testlink.utils.MiscUtil;
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (time - curTime >= 1000) {
                    curTime = time;
                    mValue = mMaxValue - mPercent * mMaxValue;
                }
